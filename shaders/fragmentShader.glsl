...
void main()
{
    ...
    //if(cubeColor != vec3(0.0,0.0,1.0))
    {
        if(fragmentColor.g == 0)
        {
            ...
            else if(fragmentColor.b<1.0 && mod(fragmentColor.b*2*_vertexWidth.y/16.0,2/16.0)<0.005)
                color  = vec4(0.0, 0.0, 0.0, 1.0);
            else
        ...
        {
            if(fragmentColor.g<1.0 && mod(fragmentColor.g*2*_vertexWidth.y/16.0,2/16.0)<0.01)
                color  = vec4(0.0, 0.0, 0.0, 1.0);
            else if(fragmentColor.b<1.0 && mod(fragmentColor.b*2*_vertexWidth.y/16.0,2/16.0)<0.005)
                color  = vec4(0.0, 0.0, 0.0, 1.0);
            else
        ...
        {
            if(fragmentColor.r<1.0 && mod(fragmentColor.r*2*_vertexWidth.z/16.0,2/16.0)<0.01)
                color  = vec4(0.0, 0.0, 0.0, 1.0);
            else if(fragmentColor.g<1.0 && mod(fragmentColor.g*2*_vertexWidth.y/16.0,2/16.0)<0.005)
                color  = vec4(0.0, 0.0, 0.0, 1.0);
            else
                color  = vec4(cubeColor, 1.0);
        }
